...
import com.speedment.demo.sakila.sakila.store.StoreImpl;
 ...
 * com.speedment.demo.sakila.sakila.store.Store} entity.
 * <p>
...
public abstract class GeneratedStoreSqlAdapter implements SqlAdapter<Store> {
    ...
    protected Store apply(ResultSet resultSet, int offset) throws SQLException {
        return createEntity()
            .setStoreId(        getInt(resultSet, 1 + offset))
            .setManagerStaffId( getInt(resultSet, 2 + offset))
            .setAddressId(      getInt(resultSet, 3 + offset))
