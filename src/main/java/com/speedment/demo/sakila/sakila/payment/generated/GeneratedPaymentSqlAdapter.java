...
import com.speedment.demo.sakila.sakila.payment.PaymentImpl;
 ...
 * com.speedment.demo.sakila.sakila.payment.Payment} entity.
 * <p>
...
public abstract class GeneratedPaymentSqlAdapter implements SqlAdapter<Payment> {
    ...
    protected Payment apply(ResultSet resultSet, int offset) throws SQLException {
        return createEntity()
            .setPaymentId(   getInt(resultSet, 1 + offset))
            .setCustomerId(  getInt(resultSet, 2 + offset))
            .setStaffId(     getInt(resultSet, 3 + offset))
