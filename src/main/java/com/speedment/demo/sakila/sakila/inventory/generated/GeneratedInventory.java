 ...
 * com.speedment.demo.sakila.sakila.inventory.Inventory}-interface representing
...
public interface GeneratedInventory {
     ...
     */
    IntForeignKeyField<Inventory, Integer, Store> STORE_ID = IntForeignKeyField.create(
        Identifier.STORE_ID,
     ...
     * @return        this Inventory instance
     */
    Inventory setStoreId(int storeId);
