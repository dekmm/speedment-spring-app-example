 ...
 * com.speedment.demo.sakila.sakila.staff_list.StaffList}-interface representing
...
public interface GeneratedStaffList {
     ...
     */
    IntField<StaffList, Integer> ID = IntField.create(
        Identifier.ID,
        StaffList::getId,
        StaffList::setId,
     ...
     */
    IntField<StaffList, Integer> SID = IntField.create(
        Identifier.SID,
        StaffList::getSid,
        StaffList::setSid,
        TypeMapper.primitive(),
