 ...
 * com.speedment.demo.sakila.sakila.store.Store}-interface.
 * <p>
...
public abstract class GeneratedStoreImpl implements Store {
    ...
    @Override
    public Store setManagerStaffId(int managerStaffId) {
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getManagerStaffId());
