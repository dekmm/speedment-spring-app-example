 ...
 * com.speedment.demo.sakila.sakila.film.Film}-interface.
 * <p>
...
public abstract class GeneratedFilmImpl implements Film {
    ...
    @Override
    public OptionalInt getOriginalLanguageId() {
        return OptionalUtil.ofNullable(originalLanguageId);
    }
    ...
    @Override
    public Film setLanguageId(int languageId) {
    ...
    @Override
    public Film setRentalDuration(int rentalDuration) {
    ...
    public Optional<Language> findOriginalLanguageId(Manager<Language> foreignManager) {
        if (getOriginalLanguageId().isPresent()) {
            return foreignManager.stream().filter(Language.LANGUAGE_ID.equal(getOriginalLanguageId().getAsInt())).findAny();
        } else {
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Integer.hashCode(getLanguageId());
        hash = 31 * hash + Objects.hashCode(OptionalUtil.unwrap(getOriginalLanguageId()));
        hash = 31 * hash + Integer.hashCode(getRentalDuration());
